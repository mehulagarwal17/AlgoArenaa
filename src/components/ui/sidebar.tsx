  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
            'hidden md:flex flex-col h-screen text-foreground transition-all duration-300 ease-in-out',
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <Separator
      ...
      className={cn("mx-2 w-auto bg-border",  !open && 'mx-auto w-1/2' ,className)}
      {...props}
    />
  )
})
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant }), 'justify-start', !open && 'justify-center', className)}
        {...props}
      >
        {children}
      </Comp>
